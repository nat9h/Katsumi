/**
 * @fileoverview Vocal remover scraper via aivocalremover.com (no API key needed).
 * Separates audio into instrumental and vocal tracks.
 * @module scrapers/voiceremoval
 */
